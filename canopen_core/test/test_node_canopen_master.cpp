...
public:
  ...
  FRIEND_TEST(NodeCanopenLMasterTest, test_construct);
    ...
    MockNodeCanopenMaster(NODETYPE* node)
...
TEST_F(NodeCanopenMasterTest, test_construct)
{
...
public:
    ...
    void SetUp() override
    {
        ...
        node_canopen_master = std::make_shared<MockNodeCanopenMaster<rclcpp_lifecycle::LifecycleNode>>(node.get());
        node_canopen_master->DelegateToBase();
    }
