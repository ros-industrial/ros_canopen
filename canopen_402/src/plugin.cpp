...
canopen::MotorBaseSharedPtr canopen::Motor402::Allocator::allocate(
  const std::string &name, canopen::ObjectStorageSharedPtr storage, const canopen::Settings &settings)
{
