...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
...
class TestableCanopenProxyController : public canopen_ros2_controllers::CanopenProxyController
{
  ...
  FRIEND_TEST(CanopenProxyControllerTest, state_joint_names_parameter_not_set);
  FRIEND_TEST(CanopenProxyControllerTest, interface_parameter_not_set);
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_CANOPEN_PROXY_CONTROLLER_HPP_
