...
{
    void ProxyDeviceDriver::on_nmt(canopen::NmtState nmt_state)
    {
    ...
    void ProxyDeviceDriver::on_tpdo(const ros2_canopen_interfaces::msg::COData::SharedPtr msg)
    {
        COData data = {msg->index, msg->subindex, msg->data, static_cast<CODataTypes>(msg->type)};
        driver->tpdo_transmit(data);
    }

    void ProxyDeviceDriver::on_rpdo(COData d)
    {
        RCLCPP_INFO(this->get_logger(),
    ...
    void ProxyDeviceDriver::on_nmt_state_reset(
    ...
    void ProxyDeviceDriver::on_sdo_write(
    ...
    // class ProxyDeviceDriver : public ProxyDriver
    // {
    // public:
    //     ProxyDeviceDriver(const rclcpp::NodeOptions &options) : ProxyDriver(options) {}
    // };
...
RCLCPP_COMPONENTS_REGISTER_NODE(ros2_canopen::ProxyDeviceDriver)