...
double MotionGenerator::getVelocity() {
	return vel;
}

double MotionGenerator::getAcceleration() {
	return acc;
}

void MotionGenerator::setMaxVelocity(double aMaxVel) {
	maxVel = aMaxVel;
}

void MotionGenerator::setMaxAcceleration(double aMaxAcc) {
	maxAcc = aMaxAcc;
}
