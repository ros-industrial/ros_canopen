...
#include <thread>
#include <atomic>
#include "ros2_canopen_core/canopen_402/base.h"
#include <functional>
...
#include "ros2_canopen_core/mc_device_driver.hpp"
...
namespace ros2_canopen
{
    ...
    template <uint16_t ID, typename TYPE, ros2_canopen::CODataTypes TPY, uint16_t OBJ, uint8_t SUB, uint16_t CW_MASK>
    class ModeForwardHelper : public ModeTargetHelper<TYPE>
    {
        ros2_canopen::MCDeviceDriver::RemoteObject obj;

    public:
        ModeForwardHelper(std::shared_ptr<ros2_canopen::MCDeviceDriver> driver) : ModeTargetHelper<TYPE>(ID),
        ...
        virtual bool write(Mode::OpModeAccesser &cw)
        {
            if (this->hasTarget())
            {
                ...
                obj.set<TYPE, TPY>(this->getTarget());
                return true;
            }
            else
            {
    ...
    typedef ModeForwardHelper<MotorBase::Profiled_Velocity, int32_t, ros2_canopen::CODataTypes::COData32, 0x60FF, 0, 0> ProfiledVelocityMode;
    typedef ModeForwardHelper<MotorBase::Profiled_Torque, int16_t, ros2_canopen::CODataTypes::COData16, 0x6071, 0, 0> ProfiledTorqueMode;
    typedef ModeForwardHelper<MotorBase::Cyclic_Synchronous_Position, int32_t, ros2_canopen::CODataTypes::COData32, 0x607A, 0, 0> CyclicSynchronousPositionMode;
    typedef ModeForwardHelper<MotorBase::Cyclic_Synchronous_Velocity, int32_t, ros2_canopen::CODataTypes::COData32, 0x60FF, 0, 0> CyclicSynchronousVelocityMode;
    typedef ModeForwardHelper<MotorBase::Cyclic_Synchronous_Torque, int16_t, ros2_canopen::CODataTypes::COData16, 0x6071, 0, 0> CyclicSynchronousTorqueMode;
    typedef ModeForwardHelper<MotorBase::Velocity, int16_t, ros2_canopen::CODataTypes::COData16, 0x6042, 0, (1 << Command402::CW_Operation_mode_specific0) | (1 << Command402::CW_Operation_mode_specific1) | (1 << Command402::CW_Operation_mode_specific2)> VelocityMode;
    typedef ModeForwardHelper<MotorBase::Interpolated_Position, int32_t, ros2_canopen::CODataTypes::COData32, 0x60C1, 0x01, (1 << Command402::CW_Operation_mode_specific0)> InterpolatedPositionMode;
    ...
    public:
        ...
        ProfiledPositionMode(std::shared_ptr<ros2_canopen::MCDeviceDriver> driver)
            : ModeTargetHelper(MotorBase::Profiled_Position),
              obj(index, 0U, ros2_canopen::CODataTypes::COData32, driver)
        {
        }
        ...
        virtual bool write(OpModeAccesser &cw)
        {
            ...
            if (hasTarget())
            {
                ...
                if ((sw_ & MASK_Acknowledged) == 0 && target != last_target_)
                {
                    ...
                    {
                        obj.set<int32_t, ros2_canopen::CODataTypes::COData32>(target);
                        cw.set(CW_NewPoint);
                        last_target_ = target;
                    }
                }
    ...
    public:
        DefaultHomingMode(std::shared_ptr<ros2_canopen::MCDeviceDriver> driver) : obj(index, 0U, ros2_canopen::CODataTypes::COData32, driver)
        {
        }
        virtual bool start();
        virtual bool read(const uint16_t &sw);
    ...
    public:
        Motor402(const std::string &name, std::shared_ptr<MCDeviceDriver> driver) : MotorBase(name),
                                                                                    ...
                                                                                    status_word_entry_(status_word_entry_index, 0U, CODataTypes::COData16, driver),
                                                                                    control_word_entry_(control_word_entry_index, 0U, CODataTypes::COData16, driver),
                                                                                    op_mode_display_(op_mode_display_index, 0U, CODataTypes::COData8, driver),
                                                                                    op_mode_(op_mode_index, 0U, CODataTypes::COData8, driver),
                                                                                    supported_drive_modes_(supported_drive_modes_index, 0U, CODataTypes::COData32, driver)
        {
            this->driver = driver;
        }
        ...
        {
            registerMode<ProfiledPositionMode>(MotorBase::Profiled_Position);
            registerMode<VelocityMode>(MotorBase::Velocity);
            registerMode<ProfiledVelocityMode>(MotorBase::Profiled_Velocity);
            registerMode<ProfiledTorqueMode>(MotorBase::Profiled_Torque);
            registerMode<DefaultHomingMode>(MotorBase::Homing);
            registerMode<InterpolatedPositionMode>(MotorBase::Interpolated_Position);
            registerMode<CyclicSynchronousPositionMode>(MotorBase::Cyclic_Synchronous_Position);
            registerMode<CyclicSynchronousVelocityMode>(MotorBase::Cyclic_Synchronous_Velocity);
            registerMode<CyclicSynchronousTorqueMode>(MotorBase::Cyclic_Synchronous_Torque);
        }
    ...
    private:
        ...
        ros2_canopen::MCDeviceDriver::RemoteObject status_word_entry_;
        ros2_canopen::MCDeviceDriver::RemoteObject control_word_entry_;
        ros2_canopen::MCDeviceDriver::RemoteObject op_mode_display_;
        ros2_canopen::MCDeviceDriver::RemoteObject op_mode_;
        ros2_canopen::MCDeviceDriver::RemoteObject supported_drive_modes_;
        const uint16_t status_word_entry_index = 0x6041;
        const uint16_t control_word_entry_index = 0x6040;
        const int8_t op_mode_display_index = 0x6061;
        const int8_t op_mode_index = 0x6060;
        const uint32_t supported_drive_modes_index = 0x6502;
    };
